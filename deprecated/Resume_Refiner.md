...
2\. The "Translator" (Tailoring to a Job Description)
-----------------------------------------------------
...
3\. The "Bullet Point Builder" (Action-Task-Result)
---------------------------------------------------
...
>
> **What I actually did:** I worked the morning shift, it was super busy, I handled the cash register, and I trained a new guy.
>
> **Target Role:** I am applying for a Data Analyst internship.
>
> **Task:** Write 3 different options for this bullet point using the 'Action + Task + Result' format. Focus on efficiency, accuracy, and training. Use strong action verbs."

4\. The "Cold Email" Architect
------------------------------
...
>
> **My Goal:** I want to ask them about their team's tech stack, NOT ask for a job directly. **My Background:** I am a CS student interested in [Specific Tech].
>
> **Task:** Draft a 50-word message that is polite, specific, and asks a smart technical question to start a conversation. Do not sound desperate."